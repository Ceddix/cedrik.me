                ...
                <main className={`flex min-h-[70vh] flex-col justify-center items-center text-center`}>
                    ...
                    <div className={"w-full max-w-[31.15rem] px-9"}>
                        <Link
                            ...
                            href={"/"}
                            className={
                                "opacity-60 pointer-events-none group my-3 inline-block w-full rounded border-2 border-gray-300/[0.3] bg-neutral-700/[.4] py-2 text-md leading-normal text-gray-200 shadow-lg"
                            }
                        >
