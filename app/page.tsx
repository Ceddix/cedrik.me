...
import AgeCalculator from '@/app/components/age-calculator';
  ...
  return (
      <PageWrapper>
          ...
          <main className={"flex flex-col justify-center items-center text-center min-h-[70vh]"}>
              ...
              <Typewriter text={`Hi, I'm Cedrik! I'm a ` + AgeCalculator('2005-10-22') + ` y/o student from Belgium!`} typeSpeed={80} startDelay={500} className={`text-[18px] text-[#94a1b2]`} />
